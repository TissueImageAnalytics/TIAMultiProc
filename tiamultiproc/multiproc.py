...
#
# The Original Code is Copyright (C) 2020, TIA Lab, University of Warwick, UK
# All rights reserved.
# ***** END GPL LICENSE BLOCK *****

"""Multiprocessing decorators to run functions written for single file
on multiple files using multiple cpu cores."""
...
class TIAMultiProcess:
    """Multiprocessing class decorator to upgrade a single core & single file function
    to multi-core multi-file, requires a list `iter_on` as input on which
